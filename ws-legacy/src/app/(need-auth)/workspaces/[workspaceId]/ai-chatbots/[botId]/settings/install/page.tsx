import PlugInButtonInstallForm from "@/domains/ai-chatbot/components/PlugInButtonInstallForm";
import { getBot } from "@/domains/ai-chatbot/actions/getBot";

export default async function AIChatbotSettingsInstallPage({
  params,
}: {
  params: { botId: string };
}) {
        ...
        <div className="flex items-center gap-[12px]">
          ...
          <div className="flex flex-col">
            ...
            <div className="whitespace-nowrap text-sm text-gray-normal">
              외부 링크 혹은 웹사이트에 챗봇을 심어 공유해보세요.
            </div>
          </div>
        </div>
      </div>
      <div className="bg-blue-lighter p-[20px]">
        <PlugInButtonInstallForm plugInId={plugIn?.id || ""} />
      </div>
    </div>
  );
}
