  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_caption: "flex justify-center h-2 mx-10 relative items-center",
        weekdays: "flex flex-row",
        weekday: "text-muted-foreground w-8 font-normal text-[0.8rem]",
        month: "gap-y-4 w-full flex flex-col items-center",
        ...
        selected: "bg-[#416BFF] text-white-normal",
      ...
      components={{
        ...
        Nav: ({ className, children, ...props }) => {
          ...
          return (
            <nav className={cn("p-3", className)} {...props}>
              <Button
                variant="outline"
